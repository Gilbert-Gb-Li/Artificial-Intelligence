...
# 文件路径
root = "../.."
trainfile = f"{root}/data/lda/train.dat"
wordidmapfile = f"{root}/data/lda/wordidmap.dat"
thetafile = f"{root}/data/lda/model_theta.dat"
phifile = f"{root}/data/lda/model_phi.dat"
paramfile = f"{root}/data/lda/model_parameter.dat"
topNfile = f"{root}/data/lda/model_twords.dat"
tassginfile = f"{root}/data/lda/model_tassign.dat"
# 模型初始参数
K = 4
alpha = 0.1
beta = 0.1
